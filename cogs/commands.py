...
class Commands(commands.Cog, name="General Commands"):
    ...
    async def modmail(self, ctx):
        ...
        await ctx.message.channel.send(
            'Need to report someone, provide feedback, or get support, ' + mention + '? Open a modmail with **!dm**')
    ...
    async def help(self, ctx):
        ...
        embed = discord.Embed(title="Trivskins Trading Bot Help", description=desc, url='https://cheddydev.com/',
                              color=0X2C3675)
