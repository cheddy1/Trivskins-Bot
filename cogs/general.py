...
class General(commands.Cog, name="General Commands"):
  ...
  async def help(self, ctx): #Help command
      ...
      features1 = 'This bot has many features, all pertaining to CS:GO trading. They include:\n\n-Screenshots from steam inspect links.\n-CS:GO inventory value from their steam profile link.\n-Allow users to recieve roles based on their CS:GO inventory value.\n-Give the average steam market value of a skin.'
      commands1 = '*These commands may only only be used in their respective channels.*\n\n**!help** *Pull up this help menu.*\n**!verify** *Gives user a value role.*\n**!value "Steam Profile Link"** *Gives the CS:GO inventory value of a steam profile. *\n**!pc "Weapon" "Skin" "(Wear)"** *Price check a skin.*\n**!invite** *Get the Discord invite link.* \n**!support** *Help support the hosting of this bot.*'
      embed = discord.Embed(title="Trvskins Trading Bot Help", description=desc, url='https://cheddydev.com/', color=0X2C3675)
